...
// ECS Library
#include <entt-2.7.3/entity/registry.hpp>
...
// Simplify Registry & Entity types.
using Registry = entt::DefaultRegistry;
using Entity   = Registry::entity_type;
using Tag      = entt::tag_t;

// Simplify graph types.
using Graph          = lemon::ListDigraph;
using Graph_Node     = lemon::ListDigraph::Node;
using Graph_Arc      = lemon::ListDigraph::Arc;
template <typename Type>
using Graph_Node_Map = lemon::ListDigraph::NodeMap<Type>;
template <typename Type>
using Graph_Arc_Map  = lemon::ListDigraph::ArcMap<Type>;

#endif // !defined(GF_Types_h__)